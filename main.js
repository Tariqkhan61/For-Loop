...
// LOOPS
for (let i = 0; i <= 5; ++i) {
    console.log(chalk.yellowBright.bold("Welcome to My new assignment Loops" + " " + i));
}
for (let a = 1; a <= 3; a++) {
    // INITIALIZE VARIABLE
    //"a" with a value of "1"
...
const hadithBooks = [
    {
        ...
        hadithCount: 7275,
        description: "It is widely regarded as the most authentic book after the Quran. Sahih al-Bukhari covers various aspects of life, including faith, rituals, ethics, and legal matters. ",
    },
    {
        name: "Sahih Muslim",
        author: "Imam Muslim ibn al-Hajjaj",
        hadithCount: 7190,
        description: "Like Sahih al-Bukhari, it covers a wide range of topics and is highly respected among Sunni Muslims.",
    },
    {
        name: "Sunan Abu Dawood",
        author: "Imam Abu Dawood",
        hadithCount: 4800,
        description: "It focuses on practical aspects of daily life, including family, social interactions, and legal rulings.",
    },
    {
        name: "Sunan at-Tirmidhi",
        author: "Imam al-Tirmidhi",
        hadithCount: 3956,
        description: "It emphasizes the virtues and character of the Prophet Muhammad, as well as legal matters.",
    },
    {
        name: "Sunan an-Nasa'i",
        author: "Imam Ahmad ibn Shu’ayb an-Nasa’i",
        hadithCount: 5761,
        description: "It covers various topics, including rituals, ethics, and legal issues.",
    },
    {
        name: "Sunan Ibn Majah",
        author: "Imam Ibn Majah",
        hadithCount: 4341,
        description: "It covers a wide range of subjects, including faith, rituals, and social matters.",
    },
];
...
for (let i = 0; i < hadithBooks.length; i++) {
    ...
    console.log(chalk.greenBright.italic(`compiled by${book.author},this collection contains around ${book.hadithCount} hadiths.`));
